...
##### FE-1: Бесшовная аутентификация (001-seamless-telegram-auth)

Как пользователь, я хочу входить в приложение через Telegram бота без ввода логина и пароля, используя мой аккаунт Telegram.

**Telegram Бот для уведомлений:**

Разработка бота (без графического интерфейса) для первого контакта и отправки уведомлений.
...
**Backend:** FastAPI на Python, python-telegram-bot для Telegram Bot API
...
- **Telegram бот** — приложение Telegram для получения и отправки текстовых сообщений, не имеющее графического интерфейса
- **Telegram Mini App** — Web App расширение Telegram бота с графическим интерфейсом
