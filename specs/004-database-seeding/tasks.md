...
- [ ] T017 [P] [US3] Handle "П" special case (is_administrator=True) in `src/services/parsers.py`
- [ ] T018 [P] [US3] Implement is_stakeholder detection from "Доля в Т" column in `src/services/parsers.py`
